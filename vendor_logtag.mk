...
PRODUCT_VENDOR_PROPERTIES += \
    ...
    persist.log.tag.DisplayManagerService=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.C2MtkComponent=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.CompositionEngine=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.C2MtkVdec=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.Codec2Client=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.CCodecConfig=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.CCodecBufferChannel=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.C2MtkVdec=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.C2MtkVdecExt=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.PipelineWatcher=$(VENDOR_LOG_LEVEL) \
